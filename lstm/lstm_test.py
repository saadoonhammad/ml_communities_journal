...
# ============================================================================
"""
Batch testing script for LSTM Autoencoder anomaly detection across multiple sensors.

This script:
1. Loads a trained LSTM autoencoder model
...
# ============================================================================
# Paths
CLUSTER = 'C4' #specify the cluster
output_cluster= 'c4' #specify the cluster 
TEST_DATA_FOLDER = f'1. Datasets/Test Sets/{CLUSTER}/'  # Folder containing all test CSV files
MODEL_DIR = f'lstm_trained_model/{output_cluster}'
OUTPUT_DIR = f'lstm_test_results_batch_{output_cluster}'  
...
if __name__ == "__main__":
    ...
    try:
        # Load model
        model = load_model(f'{MODEL_DIR}/lstm_autoencoder_{output_cluster}.h5', compile=False)
        print(f" Model loaded from: {MODEL_DIR}/lstm_autoencoder.h5")

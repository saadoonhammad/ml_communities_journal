...
class LSTMAutoencoder:
    ...
    def build_model(self):
        ...
        # Encoder
        encoded =LSTM(self.lstm_units, activation='tanh', dropout=self.dropout_rate, return_sequences=False)(inp)
        ...
        decoded = LSTM(self.lstm_units, activation='tanh', dropout=self.dropout_rate, return_sequences=True)(decoded)

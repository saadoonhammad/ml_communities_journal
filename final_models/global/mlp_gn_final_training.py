# ============================================================================
# PART 1: DATA PREPARATION AND MODEL TRAINING - MULTI-SENSOR MLP AUTOENCODER
# ============================================================================
...
OUTPUT_DIR = f'../Final Train/Network Global/mlp_trained_model/'
...
HIDDEN_UNITS = 171
ENCODING_DIM = 54
DROPOUT_RATE = 0.17380608062060293
LEARNING_RATE = 0.0001219130402167872
BATCH_SIZE = 32
EPOCHS = 150 
PATIENCE = 15  

# Additional BOHB parameter
PATIENCE_FACTOR = 0.2615820366550019
...
# ============================================================================
# MLP AUTOENCODER MODEL CLASS (From BOHB code - tanh activations)
# ============================================================================

class FusedMLPAutoencoder:
    """MLP Autoencoder for multi-sensor time series with tanh activations"""
    ...
    def build_model(self):
        """Build the MLP Autoencoder architecture with tanh activations"""
        ...
        print("\n" + "="*60)
        print("MLP AUTOENCODER ARCHITECTURE (TANH ACTIVATIONS)")
        print("="*60)
        self.model.summary()
...
if not os.path.exists(TRAIN_CSV_PATH):
    ...
    print(f"✓ Model saved: {OUTPUT_DIR}/mlp_autoencoder_{CLUSTER}.h5")
    ...
    metadata = {
        'model_type': 'mlp_autoencoder_fused',
    ...
    print("Files created:")
    print("  - mlp_autoencoder.h5 (trained model)")
    ...
    print(f"  Architecture: {HIDDEN_UNITS*2} → {HIDDEN_UNITS} → {ENCODING_DIM} bottleneck")

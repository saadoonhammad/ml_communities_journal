# ============================================================================
# LSTM AUTOENCODER - BAYESIAN HYPERBAND OPTIMIZATION (BOHB)
# ============================================================================
"""
Bayesian Hyperband Optimization (BOHB) for LSTM Autoencoder using Optuna.
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'../Logs/lstm_bohb_{datetime.now().strftime("%Y%m%d_%H%M%S")}.log'),
...
OUTPUT_PREFIX = f'{CLUSTER}_lstm_bohb_results'
...
logger.info("="*80)
logger.info("LSTM AUTOENCODER - BAYESIAN HYPERBAND OPTIMIZATION (BOHB)")
logger.info("="*80)
...
class LSTMAutoencoder:
    """Long Short-Term Memory (LSTM) Autoencoder for time series anomaly detection."""
    ...
    def build_model(self):
        ...
        # Encoder
        encoded = LSTM(self.lstm_units, activation='tanh', dropout=self.dropout_rate, 
        ...
        decoded = LSTM(self.lstm_units, activation='tanh', dropout=self.dropout_rate, 
...
class BayesianHyperbandOptimizer:
    """
    Bayesian Hyperband Optimization (BOHB) for LSTM Autoencoder.
    ...
    def run_optimization(self) -> Dict[str, Any]:
        ...
        self.study = optuna.create_study(
            ...
            sampler=sampler,
            pruner=pruner,
            study_name=f"lstm_bohb_{CLUSTER}",
...
def save_bohb_results(results: Dict[str, Any], output_dir: str = '../HPO Results/Representative/lstm_bohb_results'):
...
def plot_bohb_convergence(results: Dict[str, Any], filename: str):
    ...
    ax1.set_title('BOHB Optimization Convergence (LSTM)', fontsize=14, fontweight='bold')
...
def plot_parameter_importance(study: optuna.Study, filename: str):
    ...
    try:
        ...
        ax.set_title('Hyperparameter Importance (LSTM BOHB)', fontsize=14, fontweight='bold')

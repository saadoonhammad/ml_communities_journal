...
# ============================================================================
"""
Batch testing script for BiLSTM Autoencoder anomaly detection across multiple sensors.

This script:
1. Loads a trained BiLSTM autoencoder model
...
MODEL_DIR = f'trained_model/{output_cluster}'
OUTPUT_DIR = f'bi_test_results_batch_{output_cluster}'
...
if __name__ == "__main__":
    ...
    try:
        # Load model
        model = load_model(f'{MODEL_DIR}/bilstm_autoencoder_{output_cluster}.h5', compile=False)
        print(f" Model loaded from: {MODEL_DIR}/bilstm_autoencoder.h5")
